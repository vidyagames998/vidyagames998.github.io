...
Here are some recommendations for weapon types based on class that might be worth exploring. There's a lot of ways to play this game and each build has it's own charm. Aside from Mage these builds will be more difficult than the Halberd build we just did. 
