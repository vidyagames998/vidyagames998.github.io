...
- Rito village has the swallow bow which can be upgraded to a great eagle bow with three diamonds which has 3x with good durability
- Gerudo Desert has the scimitar of the seven 1 handed sword which pairs well with lynel horns
- The gloom weapons from defeating demon ganon and the hands are very strong, but only really worth it if you have lots of hearts unlocked as each swing hurts you
