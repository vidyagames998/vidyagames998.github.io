...
## Glitches
Depending on how updated your game is there are many ways to duplicate items, food, weapons, and upgrade materials. You could also sell negative items for rupees. All of which can save you literal days of grinding. It feels cheap, it's not in the spirit of the game and the glitches that work on the game with the latest patches are not the easiest to do. You used to be able to just jump in the air, open the menu, hold items, exit the menu, fall to the ground and pick up duplicates. Speedrunners typically open the menu multiple times per jump and can turn 1 item to 23 in seconds. There was also a rupee glitch where you could get negative items and sell them to a shop keep using a horse and memories giving you max rupees in minutes The current working methods are complex and not nearly as easy to pull off. If you want to learn more you can do so here: https://www.youtube.com/watch?v=atx72hKDDNY
