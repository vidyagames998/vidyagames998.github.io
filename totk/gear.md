...
Directly west of Eldin Canyon skyview tower is a chest with a cobble crusher in it. A hidden stat bonus causes most rocks to break with 1 hit from it. It's durability is not the best, but like the Zora spear there are hidden stats and upgrades. To start fusing a rock adds durability. The hidden stat does 1.5x the damage to battle taluses. You can also get an undecayed version after breaking it for higher durability and stats. Fusing a rare stone battle talus heart adds higher damage and durability. The sword has a slow damage per second compared to spears but also has a .95 multiplyer vs .75, to help get around this difference you can also do spinning charged attacks. In goron city you can upgrade this to a Boulder Breaker (60 durability) with three diamonds to get a 38 base attack with a 2x attack bonus against taluses. So with a Boulder Breaker fused with rare stone battle talus heart with attack up armor against a battle talus you can do `38+32*2*1.5*.95=199.5` which makes for a good alternative to spending spear durability to farm the taluses. 
